    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == ACTION_TOGGLE_EVENT) {
            ...
            if (
                ...
                manager.notifyAppWidgetViewDataChanged(intArrayOf(appWidgetId), R.id.eventList)
...
internal fun updateWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
    ...
    try {
        ...
        appWidgetManager.notifyAppWidgetViewDataChanged(intArrayOf(appWidgetId), R.id.eventList)
